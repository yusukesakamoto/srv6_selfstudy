...
ip netns exec host2 sysctl -w net.ipv6.conf.all.forwarding=1
...
ip netns exec router1 sysctl -w net.ipv6.conf.all.seg6_enabled=1
ip netns exec router2 sysctl -w net.ipv6.conf.all.seg6_enabled=1
...
ip netns exec router1 ip -6 route add 2001:db8:c::/48 via 2001:db8:b::d
ip netns exec router1 ip -6 route add 2001:db8:1::/48 via 2001:db8:3::1
ip netns exec router1 ip -6 route add 2001:db8:2::/48 via 2001:db8:b::d
ip netns exec router1 ip -6 route add 2001:db8:4::/48 via 2001:db8:b::d
ip netns exec router2 ip -6 route add 2001:db8:a::/48 via 2001:db8:b::c
ip netns exec router2 ip -6 route add 2001:db8:3::/48 via 2001:db8:b::c
ip netns exec router2 ip -6 route add 2001:db8:1::/48 via 2001:db8:b::c
ip netns exec router2 ip -6 route add 2001:db8:2::/48 via 2001:db8:4::1
...
ip -6 route add 2001:db8:2::/48 via 2001:db8:1::893 table 10
ip -6 route add 2001:db8:a::/48 via 2001:db8:3::2 table 10
...
ip -6 route add 2001:db8:1::/48 via 2001:db8:2::893 table 20
ip -6 route add 2001:db8:c::/48 via 2001:db8:4::2 table 20

ip netns exec router1 ip -6 route del 2001:db8:c::/48 via 2001:db8:b::d
